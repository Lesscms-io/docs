...
| `widget.filter_entry_field_code` | string\|null | Field code from current collection entry to use as filter value (used when `filter_value_source` is `"entry_field"`) |
